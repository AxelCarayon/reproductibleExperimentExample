...
if __name__ == '__main__':
    ...
    g.add_argument("-i", "--input", help="Using input files described in the inputs.yaml file")
    ...
    if args.generate:
        ...
        inputFiles = numberGenerator.generateInputFiles(input_folder)
        ...
        inputFiles = numberGenerator.generateInputFiles(input_folder, args.generateAndStore)
    elif args.input:
